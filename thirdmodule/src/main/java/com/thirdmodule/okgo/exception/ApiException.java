...
package com.thirdmodule.okgo.exception;
...
public class ApiException extends Exception {
    ...
    public ApiException(Throwable throwable, int code, int serverCode) {
        super(throwable);
        this.code = code;
    ...
    public static ApiException handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            ex = new ApiException(httpException, ERROR.HTTP_EXCEPTION, httpException.code());
            ...
            ex = new ApiException(resultException, ERROR.SERVER_EXCEPTION, resultException.getErrCode());
            ...
            ex = new ApiException(e, ERROR.CUSTOM_EXCEPTION);
    ...
    public static class ERROR {
         ...
         * http错误
         */
        public static final int HTTP_EXCEPTION = NULLPOINTER_EXCEPTION + 1;
        /**
         * 服务器业务返回错误
         */
        public static final int SERVER_EXCEPTION = HTTP_EXCEPTION + 1;
        /**
         * 自定义错误
         */
        public static final int CUSTOM_EXCEPTION = SERVER_EXCEPTION + 1;
    }
}