...
public class AddSpaceTextWatcher implements TextWatcher {
    ...
    private AddSpaceTextWatcher(EditText editText, SpaceType spaceType, int maxLength) {
    ...
    public static void bindEditText(EditText editText, SpaceType spaceType, int maxLength) {
        new AddSpaceTextWatcher(editText, spaceType, maxLength);
    }
